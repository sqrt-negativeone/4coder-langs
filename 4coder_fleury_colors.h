...
CUSTOM_ID(colors, fleury_color_index_rust_module);
CUSTOM_ID(colors, fleury_color_builtin_function);
CUSTOM_ID(colors, fleury_color_index_cpp_namespace);
CUSTOM_ID(colors, fleury_color_index_rust_trait);
